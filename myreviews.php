...
<div class="bg-color">
    ...
    <div class="bread_crum">
        ...
        <i class="fas fa-chevron-right"></i> <span>My Reviews</span>
    </div>
    <!-- bread-crum -->
        ...
        <div class="living_room_layout">
         ...
         <img src="asset/images/wallet-logo.png" alt=""><p>Your Wallet</p>
                ...
                <div class="wallet_links">
                    <div class="d-flex">
                        <a href="#0" class="wallet_parent" data-id="wallet_status">To Be Reviewed</a>
                        <a href="#0" class="wallet_parent" data-id="wallet_transaction">History</a>
                    </div>
                </div>
